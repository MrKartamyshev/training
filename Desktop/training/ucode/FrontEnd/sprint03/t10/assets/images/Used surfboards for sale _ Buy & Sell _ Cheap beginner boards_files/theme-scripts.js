...
tjq('.signuptype').on('change',function(){

//alert( this.value ); // or $(this).val()

        if(tjq(this).val()==="shop"){
        tjq("#shopsel").show()
        tjq("#privatesel").hide()
...
tjq( ".listlink" ).click(function() {

	
	 red = tjq(this).data('id');

     document.getElementById('redme').value = red ;
     document.getElementById('redmelogin').value = red ;
     document.getElementById('redmelogin1').value = red ;
     document.getElementById('redmelogin2').value = red ;
     document.getElementById('redmelogin3').value = red ;
...
tjq( ".loginbutton" ).click(function() {
...
$.ajax({
    ...
    tjq( ".loginbutton2" ).click(function(e) {
...
$.ajax({
    type: "POST",
    url: "login2017.php?action=login",
    data: datastring,
    dataType: "json",
    success: function(data) {
...
tjq( ".loginbutton3" ).click(function(e) {
...
$.ajax({
    type: "POST",
    url: "login2017.php?action=login",
 data: $('#login_form').serialize()+"&location="+window.location.href,
    success: function (response) {
    
   console.log(response);
      var resp = response;
      if(JSON.parse(resp).success){
      var resp_val = JSON.parse(resp).location;
    var list_val = JSON.parse(resp).list;
    var reset_val = JSON.parse(resp).reset;
    var mes = JSON.parse(resp).messages;
  

if(mes == "Y"){
    window.open("redirectmymessages.php","_self");
} 

else if(list_val == "true"){
    window.open("redirectmyshb.php","_self");
} 

else if (reset_val === "Y")

{
    window.open("redirectmyshbpass.php","_self");
} 
...
e.preventDefault();
    ...
    tjq( ".loginbutton4" ).click(function(e) {
...
$.ajax({
    type: "POST",
    url: "login2017.php?action=forgot_process",
    data: datastring,
    ...
    success: function(response) {
        ...
        if(JSON.parse(resp).sent){

        var sent = JSON.parse(resp).sent;
...
tjq( ".signupbutton" ).click(function(e) {
...
$.ajax({
    type: "POST",
    url: "sign_up.php?action=sign_up",
 data: $('#registration').serialize()+"&location="+window.location.href,
    success: function (response) {
    
      console.log(response);
      var resp = response;
      
      if(JSON.parse(resp).exists){
...
$('.mydivinfo2').hide();
                                            ...
                                            var le = JSON.parse(resp).email;
                                            var lp = JSON.parse(resp).pwd;
                                            var rm = JSON.parse(resp).redmelogin;
                                            ...
                                            data: "login_email="+le+"&login_password="+lp+"&redme="+rm,
                                            ...
                                            var resp = response2;
                                                ...
                                                var location = JSON.parse(resp).location;
...
//location.href = URL_add_parameter(location.href, 'register', 'true');
